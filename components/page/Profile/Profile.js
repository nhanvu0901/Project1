...
export default function Profile() {
  ...
  const [displaySumOfPic,setDiplaySumOfPi] = useState("0")
  ...
  async function handleClick() {
    ...
    if(photo){
    await uploadAvatar(photo, currentUser);
    }
    if(displayNameEdit !== displayName || displayJobEdit !== "Job:" || displayPresent !=="Present:"  || photo !==''){
  ...
  useEffect(() => {
    ...
    const fetchData = async () => {
        ...
        if (docSnap.exists()) {
          ...
          setDiplaySumOfPi(docSnap.data().numOfPic)
        } else {
  ...
  }, [currentUser,displayJob,displayPresent,displaySumOfPic])
        ...
        <div className="profile-container">
          ...
          <div className="info">
            ...
            <div className="info-box">
              ...
              <p id="present">{displaySumOfPic}</p>
            </div>
          </div>
